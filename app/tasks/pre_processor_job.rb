class PreProcessorJob
  ...
  def self.perform(design_id)
    ...
    thumbnail_cmd  = "convert #{screenshot_file} -thumbnail 240x180 -unsharp 0x.5 #{thumbnail_file}"
    ...
    Store.save_to_store screenshot_file, File.join(design.store_key_prefix, "#{psd_file_root}.png")
    Store.save_to_store thumbnail_file, File.join(design.store_key_prefix, "#{psd_file_root}-thumbnail.png")
  end
end