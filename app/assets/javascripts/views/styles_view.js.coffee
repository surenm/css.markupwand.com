class StylesView extends Backbone.View
  ...
  tour_handler: (event) ->
    ...
    tour.addStep 
      element: ".canvas-area"
      title: "Design Canvas"
      content: "<b>Click layers</b> in this canvas"
      placement: "right"
      animation: true
    ...
    tour.addStep 
      ...
      content: "<b>SCSS</b> appears here (CSS in other tab)"
      placement: 'left'
      animation: true    
      delay: { show: 1500, hide: 100 }
    ...
    tour.addStep 
      ...
      title: "All images"
      content: "<b>Rename, crop or download</b> images in images tab"
      placement: 'bottom'
      animation: true
      delay: { show: 1500, hide: 100 }
    ...
    tour.addStep 
      element: "#zoom"
      title: "Zoom"
      content: "<b>Zoom</b> images for precise measurement"
      placement: 'bottom'
      animation: true
      delay: { show: 1500, hide: 100 }
    ...
    tour.addStep 
      ...
      content: "<b> Draw boxes in canvas </b> to measure distances/dimensions."
      placement: 'bottom'
      animation: true
      delay: { show: 1500, hide: 100 }
