...
worker:        bundle exec rake resque:work QUEUE=uploader,pre_processor,parser,generator,html_writer
uploader:      bundle exec rake resque:work QUEUE=uploader
pre_processor: bundle exec rake resque:work QUEUE=pre_processor
